...
`mature-senpai-commercial-v12`, with `mature-senpai-mcp-polish-v2` retained as the
visual fallback and `mature-senpai-commercial-v11` retained as the engineered
split-part/morph reference candidate.
