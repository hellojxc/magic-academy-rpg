...
export const matureSenpaiSpec: CharacterSpec = {
  ...
  displayName: 'Elena',
  designIntent:
    'A mature big-sister academy NPC based on the v7 Hunyuan/illustration reference: burgundy long hair, elegant ivory camisole top, lavender double side-slit skirt, and Roman-style strappy high heels. Runtime uses the commercial v8 asset because it preserves the v7 likeness while adding the retopo/partition/weighting delivery layer: named skinned submeshes, six facial morph targets, explicit per-part weight profiles, source-normal seam cleanup, dialogue-distance facial detail overlays, visible strap/pendant details, hair-tip and skirt-tip secondary bones, and clean skinned arm/hand meshes with separate fingers, thumbs, and soft nail surfaces; the commercial v7 asset remains available as fallback.',
  body: {
    heightMeters: 1.72,
    headToBodyRatio: 0.18,
    silhouette: 'teacher',
  ...
  runtime: {
    role: 'supporting',
    preferredAssetId: 'mature-senpai-commercial-v8',
