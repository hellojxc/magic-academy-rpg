"""
Build mature_senpai_commercial_v7 from the Hunyuan/BlenderMCP v2 runtime asset.
...
OUTPUT_GLB = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v7.glb"
OUTPUT_PNG = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v7.png"
OUTPUT_BLEND = PROJECT_ROOT / "assets/characters/mature_senpai/source/mature_senpai_commercial_v7.blend"
OUTPUT_REPORT = PROJECT_ROOT / "assets/characters/mature_senpai/mature_senpai_commercial_v7.report.json"
...
def make_parts(source: bpy.types.Object, armature: bpy.types.Object) -> tuple[list[bpy.types.Object], bpy.types.Collection]:
    collection = bpy.data.collections.new("MatureSenpai_CommercialV7_Parts")
...
def add_natural_arm_hand_meshes(
    ...
    skin = make_material("CommercialV7_NaturalAnimeSkin_ArmsHands", (0.94, 0.76, 0.68, 1.0), 0.58)
    nail = make_material("CommercialV7_SoftNails", (0.98, 0.86, 0.82, 1.0), 0.52)
    ...
    def build_side(side_name: str, sign: float) -> bpy.types.Object:
        ...
        obj["commercial_v7_part"] = f"{side_name}NaturalArmHand"
        obj["commercial_v7_geometry_cleanup"] = "replaces noisy source Arms_Hands geometry with natural arm, palm, finger, and nail shapes"
        return obj
...
def add_face_detail_overlays(armature: bpy.types.Object, collection: bpy.types.Collection) -> list[bpy.types.Object]:
    ...
    overlay["commercial_v7_part"] = "Face_DialogueDetails"
    return [overlay]
...
def write_report(
    ...
    report = {
        "assetId": "mature-senpai-commercial-v7",
        ...
        "blendSource": "assets/characters/mature_senpai/source/mature_senpai_commercial_v7.blend",
        "output": "public/assets/models/mature_senpai_commercial_v7.glb",
        "thumbnail": "public/assets/models/mature_senpai_commercial_v7.png",
        "generatedBy": "BlenderMCP execute_code + assets/characters/mature_senpai/tools/build_final_v7.py",
        ...
        "runtimeDecision": {
            "defaultAsset": True,
            "fallbackAssetId": "mature-senpai-commercial-v6",
            "reason": "This v7 asset extends v6 with more natural clean skinned arm and hand geometry, including tapered upper arms, elbow/forearm proportions, palm blocks, separate fingers, thumbs, and soft nail surfaces, while preserving the split skinned runtime mesh, six facial morph targets, face overlays, refreshed rule-painted weights, and secondary hair/skirt/strap/pendant bone hooks.",
        },
        "completedPasses": [
            "helper mesh removal",
        ...
        "limitations": [
            ...
            "The v7 arm/hand cleanup is more natural than v6 but still generated geometry; final art still needs hand-authored anatomy, knuckles, nails, and skin texture.",
