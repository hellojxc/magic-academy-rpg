"""
Build mature_senpai_commercial_v9 from the Hunyuan/BlenderMCP v2 runtime asset.
...
OUTPUT_GLB = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v9.glb"
OUTPUT_PNG = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v9.png"
OUTPUT_BLEND = PROJECT_ROOT / "assets/characters/mature_senpai/source/mature_senpai_commercial_v9.blend"
OUTPUT_REPORT = PROJECT_ROOT / "assets/characters/mature_senpai/mature_senpai_commercial_v9.report.json"
...
def make_parts(source: bpy.types.Object, armature: bpy.types.Object) -> tuple[list[bpy.types.Object], bpy.types.Collection]:
    collection = bpy.data.collections.new("MatureSenpai_CommercialV9_Parts")
    ...
    for part in PART_ORDER:
        ...
        if part == "Face_Head":
            add_face_morphs(obj)
        obj["commercial_v9_part"] = part
        obj["commercial_v9_retopo_layer"] = "source-preserving split runtime mesh"
        obj["commercial_v9_weight_profile"] = f"explicit profile weights for {part}"
        parts.append(obj)
...
def add_natural_arm_hand_meshes(
    ...
    skin = make_material("CommercialV9_NaturalAnimeSkin_ArmsHands", (0.94, 0.76, 0.68, 1.0), 0.58)
    nail = make_material("CommercialV9_SoftNails", (0.98, 0.86, 0.82, 1.0), 0.52)
    knuckle = make_material("CommercialV9_SoftKnuckleShade", (0.88, 0.58, 0.56, 1.0), 0.72)
    ...
    def build_side(side_name: str, sign: float) -> bpy.types.Object:
        ...
        obj["commercial_v9_part"] = f"{side_name}NaturalArmHand"
        obj["commercial_v9_retopo_layer"] = "rebuilt clean arm/hand runtime mesh"
        obj["commercial_v9_weight_profile"] = f"explicit profile weights for {side_name}UpperArm/{side_name}LowerArm/{side_name}Hand"
        obj["commercial_v9_geometry_cleanup"] = "replaces noisy source Arms_Hands geometry with natural arm, palm, finger, and nail shapes"
        return obj
...
def add_face_detail_overlays(armature: bpy.types.Object, collection: bpy.types.Collection) -> list[bpy.types.Object]:
    ...
    overlay["commercial_v9_part"] = "Face_DialogueDetails"
    return [overlay]
...
def summarize_parts(parts: list[bpy.types.Object]) -> list[dict[str, object]]:
    ...
    for obj in parts:
        ...
        summaries.append({
            ...
            "retopoLayer": obj.get("commercial_v9_retopo_layer", "source-preserving split runtime mesh"),
            "weightProfile": obj.get("commercial_v9_weight_profile", "explicit profile weights"),
        })
    return summaries
...
def write_report(
    ...
    report = {
        "assetId": "mature-senpai-commercial-v9",
        "characterId": "mature_senpai",
        "status": "active-closeup-hand-material-polish-preview",
        "source": "public/assets/models/mature_senpai_mcp_polish_v2.glb",
        "blendSource": "assets/characters/mature_senpai/source/mature_senpai_commercial_v9.blend",
        "output": "public/assets/models/mature_senpai_commercial_v9.glb",
        "thumbnail": "public/assets/models/mature_senpai_commercial_v9.png",
        "generatedBy": "BlenderMCP execute_code + assets/characters/mature_senpai/tools/build_final_v9.py",
        "runtime": {
            "defaultAsset": True,
            "format": "glb",
            "url": "/assets/models/mature_senpai_commercial_v9.glb",
            "thumbnailUrl": "/assets/models/mature_senpai_commercial_v9.png",
            "fallbackAssetId": "mature-senpai-commercial-v8",
        ...
        "runtimeDecision": {
            "defaultAsset": True,
            "fallbackAssetId": "mature-senpai-commercial-v8",
            "reason": "This v9 asset keeps the v8 retopo/partition/morph/weight/secondary-bone layer and improves close-up hand readability by replacing box fingers with rounded segmented finger and thumb tubes, soft nail surfaces, and subtle knuckle shade planes while preserving the v7/v8 likeness and web runtime budget.",
        },
        "completedPasses": [
            "helper mesh removal",
        ...
        "limitations": [
            "The v9 retopo layer is a hybrid runtime retopo that preserves Hunyuan texture-critical triangles for likeness; it is not a fully artist-drawn quad topology over the whole body.",
            ...
            "The v9 arm/hand cleanup uses rounded segmented fingers and nail surfaces, but it is still generated geometry; final art still needs hand-authored anatomy, knuckles, nails, and skin texture.",
