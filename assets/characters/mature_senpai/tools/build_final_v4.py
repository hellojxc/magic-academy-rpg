"""
Build mature_senpai_commercial_v4 from the Hunyuan/BlenderMCP v2 runtime asset.
...
OUTPUT_GLB = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v4.glb"
OUTPUT_PNG = PROJECT_ROOT / "public/assets/models/mature_senpai_commercial_v4.png"
OUTPUT_BLEND = PROJECT_ROOT / "assets/characters/mature_senpai/source/mature_senpai_commercial_v4.blend"
OUTPUT_REPORT = PROJECT_ROOT / "assets/characters/mature_senpai/mature_senpai_commercial_v4.report.json"
...
def make_parts(source: bpy.types.Object, armature: bpy.types.Object) -> tuple[list[bpy.types.Object], bpy.types.Collection]:
    collection = bpy.data.collections.new("MatureSenpai_CommercialV4_Parts")
...
def write_report(parts: list[bpy.types.Object], armature: bpy.types.Object) -> None:
    ...
    report = {
        "assetId": "mature-senpai-commercial-v4",
        ...
        "blendSource": "assets/characters/mature_senpai/source/mature_senpai_commercial_v4.blend",
        "output": "public/assets/models/mature_senpai_commercial_v4.glb",
        "thumbnail": "public/assets/models/mature_senpai_commercial_v4.png",
        "generatedBy": "BlenderMCP execute_code + assets/characters/mature_senpai/tools/build_final_v4.py",
        "parts": [
            {
                "name": obj.name,
        ...
        "runtimeDecision": {
            "defaultAsset": True,
            "fallbackAssetId": "mature-senpai-retopo-v3",
            "reason": "This v4 asset extends v3 with source-normal seam reduction, six facial morph targets, visible strap/pendant detail meshes, and secondary strap/pendant bone hooks while preserving the Hunyuan v7 likeness.",
        },
        "completedPasses": [
            "helper mesh removal",
