"""
Build mature_senpai_retopo_v3 from the Hunyuan/BlenderMCP v2 runtime asset.
...
- preserve the existing humanoid and secondary-motion armature
...
OUTPUT_GLB = PROJECT_ROOT / "public/assets/models/mature_senpai_retopo_v3.glb"
OUTPUT_PNG = PROJECT_ROOT / "public/assets/models/mature_senpai_retopo_v3.png"
OUTPUT_BLEND = PROJECT_ROOT / "assets/characters/mature_senpai/source/mature_senpai_retopo_v3.blend"
OUTPUT_REPORT = PROJECT_ROOT / "assets/characters/mature_senpai/mature_senpai_retopo_v3.report.json"
...
def build_part_mesh(
    ...
    normal = obj.modifiers.new("Production weighted normals", "WEIGHTED_NORMAL")
...
def add_face_morphs(face: bpy.types.Object) -> list[str]:
    ...
    morph_names = ["Blink", "WarmSmile", "Surprised"]
...
def make_parts(source: bpy.types.Object, armature: bpy.types.Object) -> list[bpy.types.Object]:
    collection = bpy.data.collections.new("MatureSenpai_RetopoV3_Parts")
...
def write_report(parts: list[bpy.types.Object], armature: bpy.types.Object) -> None:
    ...
    report = {
        "assetId": "mature-senpai-retopo-v3",
        "characterId": "mature_senpai",
        "status": "active-runtime-preview",
        "source": "public/assets/models/mature_senpai_mcp_polish_v2.glb",
        "blendSource": "assets/characters/mature_senpai/source/mature_senpai_retopo_v3.blend",
        "output": "public/assets/models/mature_senpai_retopo_v3.glb",
        "thumbnail": "public/assets/models/mature_senpai_retopo_v3.png",
        "generatedBy": "BlenderMCP execute_code + assets/characters/mature_senpai/tools/build_retopo_v3.py",
        "parts": [
            {
                "name": obj.name,
        ...
        "runtimeDecision": {
            ...
            "reason": "This v3 asset adds runtime-visible production structure: named skinned submeshes, facial morph targets, rule-painted weights, and secondary hair/skirt bone hooks while preserving the Hunyuan v7 likeness.",
        },
        "completedPasses": [
            "helper mesh removal",
            ...
            "facial morph targets: Blink, WarmSmile, Surprised",
            "secondary hair and skirt bone weight refresh",
        ...
        "limitations": [
            ...
            "Facial morphs are subtle geometric morph targets on the generated face surface, not sculpted expression blendshapes.",
...
def main() -> dict:
    ...
    parts = make_parts(source, armature)
    tune_materials(parts)
    render_preview(parts)
    export_outputs(parts, armature)
    write_report(parts, armature)
    return {
        "glb": str(OUTPUT_GLB),
        "png": str(OUTPUT_PNG),
