...
- Prompt: assets/characters/mira_voss/candidates/jobs/mira-voss-charactergen-001/prompt.md
- Expected output folder: assets/characters/mira_voss/candidates/jobs/mira-voss-charactergen-001/outputs

After generation, export or copy the best GLB/OBJ result and register it:

```sh
npm run assets:characters:candidate:register -- --character mira_voss --tool charactergen --job mira-voss-charactergen-001 --input /path/to/generated.glb
```
