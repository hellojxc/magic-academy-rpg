...
- Prompt: assets/characters/player/candidates/jobs/player-skintokens-001/prompt.md
- Expected output folder: assets/characters/player/candidates/jobs/player-skintokens-001/outputs

Register the rigged candidate after exporting GLB:

```sh
npm run assets:characters:candidate:register -- --character player --tool skintokens --job player-skintokens-001 --input /path/to/rigged.glb
```
